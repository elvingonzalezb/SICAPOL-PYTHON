...
urlpatterns = [
    ...
    path('actas/', include('aplicaciones.actas.urls')),
    path('tipopersona/', include('aplicaciones.tipopersona.urls')),
    path('contacto/', include('aplicaciones.contacto.urls')),
    path('usuario/', include('aplicaciones.usuario.urls')),
    path('tipoarma/', include('aplicaciones.tipoarma.urls')),
]